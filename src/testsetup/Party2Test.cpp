...
int main() {
    ...
    // circuit.runOffline();
    // std::vector<uint64_t> vecc = {double2fix<uint64_t>(0.123),
    ...
    // std::vector<uint64_t> vecb = {2 , 5 , 7 , 9};
    // b->setInput(vecb);
    // circuit.runOffline();
    // circuit.runOnline();
    // auto o = d->getClear();
